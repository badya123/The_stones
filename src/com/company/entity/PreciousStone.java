...
public class PreciousStone implements IStone {
	private int id;
	private String name;
	private String type;
	private int price;
	...
	public PreciousStone(int id, String name, String type, int price, int necklaceId, double weight) {
		super();
		this.id = id;
		this.name = name;
		this.type = type;
	...
	public String toString() {
		return "PreciousStone [id=" + id + ", name=" + name + ", type=" + type + ", price=" + price + ", necklaceId="
				+ necklaceId + "]";
	}
